			...
			<div class ="ui centered grid">
				<div class="column">
					 <form class= "ui inverted form" >
							...
							<input type="text" id="txtContent" name="desc" class="desc" placeholder="Enter TODO Name">
						</div>
						...
						<div class="field">
							  <label>TODO Type</label>
								<select  name ="todoType" id="todoType" class="ui fluid dropdown">
						  ...
						  <div class="four wide field">
							  ...
							  <input name="count" id="itemCount" type="tel" placeholder="Item Count">
							</div>
						</div>
					...
					<input  id="btnAddTodo" type="submit" class="ui inverted green basic button" value="Add"/>
